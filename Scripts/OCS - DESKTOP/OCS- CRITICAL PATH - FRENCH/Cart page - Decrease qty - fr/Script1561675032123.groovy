...
not_run: WebUI.sendKeys(findTestObject('OCS-DESKTOP/Cart page/Quantity Input field'), Keys.chord(Keys.CLEAR))
...
WebUI.callTestCase(findTestCase('OCS - DESKTOP/CALL - CART PAGE - SHIPPING TO PAYMENT'), [:], FailureHandling.STOP_ON_FAILURE)
