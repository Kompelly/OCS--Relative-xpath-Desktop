...
WebUI.click(findTestObject('FRENCH/Quantity Increase - Button'))
...
String a1 = b.substring(0, b.length() - 1)
...
//
WebUI.click(findTestObject('FRENCH/input_-_updates'))

not_run: WebUI.setText(findTestObject('OCS-DESKTOP/Cart flyout/input_-_updates'), Keys.chord(Keys.CLEAR))
...
String a2 = d.substring(0, d.length() - 1)
