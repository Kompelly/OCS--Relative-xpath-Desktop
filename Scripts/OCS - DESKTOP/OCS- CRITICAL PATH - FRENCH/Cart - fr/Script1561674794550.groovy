...
not_run: WebUI.click(findTestObject('OCS-DESKTOP/Home - page/Cart icon -bag'), FailureHandling.OPTIONAL)
...
WebUI.click(findTestObject('FRENCH/Remove icon - 1st Product'))
