...
not_run: WebUI.scrollToElement(findTestObject('OCS-MOBILE /Product page/How to choose cannabis product - Section'), 2)

WebUI.click(findTestObject('OCS-DESKTOP/Product page/How to choose cannabis product - Button'))
