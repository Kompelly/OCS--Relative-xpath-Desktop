...
WebUI.scrollToElement(findTestObject('OCS-DESKTOP/Product page/Product image'), 1)
...
not_run: WebUI.scrollToElement(findTestObject('OCS-DESKTOP/Product page/Add to Bag-button'), 0)

not_run: WebUI.scrollToElement(findTestObject('OCS-MOBILE /Product page/Product image'), 1)

WebUI.delay(2)

String a = WebUI.getText(findTestObject('OCS-DESKTOP/Product page/Price/1g Price - Swatch'))

WebUI.comment('a =' + a)

WebUI.delay(1, FailureHandling.OPTIONAL)

boolean flag = WebUI.verifyElementPresent(findTestObject('OCS-DESKTOP/Product page/Price/Price - Add to cart button'), 0, 
    FailureHandling.CONTINUE_ON_FAILURE)

WebUI.comment('flag =' + flag)

if (flag == true) {
    String b = WebUI.getText(findTestObject('OCS-DESKTOP/Product page/Price/Price - Add to cart button'))
    ...
    String c = WebUI.getText(findTestObject('OCS-DESKTOP/Product page/Price/3.5g Price - Swatch'), FailureHandling.STOP_ON_FAILURE)
    ...
    String d = WebUI.getText(findTestObject('OCS-DESKTOP/Product page/Price/Price - Add to cart button'))
    ...
    WebUI.click(findTestObject('OCS-DESKTOP/Collection page/Product image - 2nd one'))
    ...
    String p1 = WebUI.getText(findTestObject('OCS-DESKTOP/Product page/Price/1g Price - Swatch'))

    WebUI.comment('p1 =' + p1)

    WebUI.delay(1, FailureHandling.OPTIONAL)

    boolean flag1 = WebUI.verifyElementPresent(findTestObject('OCS-DESKTOP/Product page/Price/Price - Add to cart button'), 
