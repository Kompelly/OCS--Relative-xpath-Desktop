...
boolean flag1 = WebUI.verifyElementClickable(findTestObject('OCS-DESKTOP/Product page/Swatch_1g'))
...
boolean flag2 = WebUI.verifyElementClickable(findTestObject('OCS-DESKTOP/Product page/Swatch_3.5g'))
...
boolean flag3 = WebUI.verifyElementClickable(findTestObject('OCS-DESKTOP/Product page/Swatch_7g'))
