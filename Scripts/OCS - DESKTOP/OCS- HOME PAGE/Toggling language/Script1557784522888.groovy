...
WebUI.click(findTestObject('OCS-DESKTOP/Cart flyout/English dropdown'))
...
WebUI.click(findTestObject('OCS-DESKTOP/Cart flyout/Select French'))
...
WebUI.click(findTestObject('OCS-DESKTOP/Cart flyout/French dropdown'))

WebUI.delay(2)

WebUI.click(findTestObject('OCS-DESKTOP/Cart flyout/Select English'))
